...
white = (255, 255, 255)
tile_size = 80
font_medium = pygame.font.Font('./src/OpenSans-Regular.ttf', 28)
font_large = pygame.font.Font('./src/OpenSans-Regular.ttf', 40)
font_move = pygame.font.Font('./src/OpenSans-Regular.ttf', 60)
